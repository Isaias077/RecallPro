            ...
            {user && (
              <Box sx={{ flexGrow: 0 }}>
                <Tooltip title="Open settings">
                  <IconButton onClick={handleOpenUserMenu} sx={{ p: 0, color: '#1D1C1A' }}>
                    <Avatar alt={user.email?.charAt(0).toUpperCase() || 'U'} src="/static/images/avatar/2.jpg" />
                  </IconButton>
                </Tooltip>
                <Menu
                  sx={{ mt: '45px' }}
                ...
                >
                  <MenuItem onClick={handleLogout}>
                    <ListItemIcon>
                      <LogoutIcon fontSize="small" sx={{ color: '#1D1C1A' }} />
                    </ListItemIcon>
                    <Typography textAlign="center" sx={{ color: '#1D1C1A' }}>Cerrar Sesión</Typography>
                  </MenuItem>
                </Menu>
              </Box>
            )}
